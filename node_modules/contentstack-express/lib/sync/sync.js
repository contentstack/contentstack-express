    ...
    try {
        ...
        d.run(function () {
            ...
            switch (_data.object.type) {
                ...
                case _types.asset:
                    context.set("lang", data.lang.code);
                    if(_data.object.entry && _data.object.entry.is_dir && typeof _data.object.entry.is_dir === "boolean") {
...
Sync.prototype.bulkAssetDelete = function (languages, folder) {
    var self = this;
    try {
        var folderUid = folder.object.entry.uid;
        async
            .series([
                function (callback) {
                    status(folder, {
                                        ...
                                        if (data && data.length) {
                                            for (var i = 0, _i = data.length; i < _i; i++) {
                                                _calls.push((function (asset) {
                                                    return function (_cb) {
                                                        helper.getAssets(asset.uid, lang, true, _cb);
                                                    }
                                                })(data[i]))
                                            }
                                            async.parallelLimit(_calls, 1, function (err, data) {
                                                if (!err) {
                                                    cb()
                                                } else {
                                                    cb(err)
