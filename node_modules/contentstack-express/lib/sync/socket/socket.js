                            ...
                            var start = function (env) {
                                ...
                                socket.on('create', function (data) {
                                    ...
                                    if (helper.isValid(data.resource, env.environment.uid, server) && !data.resource.scheduled_at) {
                                        ...
                                        if (data.resource.type != 'form' && data.resource.type != 'folder' && data.resource.locale && data.resource.locale.length && ~_.findIndex(languages, 'code', data.resource.locale[0])) {
                                            lang = languages[_.findIndex(languages, 'code', data.resource.locale[0])];
                                            proceed(msg, lang);
                                        } else if (data.resource.type == 'form' || data.resource.type == 'folder') {
                                        ...
                                        helper.queueEntry(_url, headers, function (err, object) {
                                            if (err) {
                                                ...
                                                if (helper.isValid(object, env.environment.uid, server)) {
                                                    ...
                                                    if (object.type != 'form' && object.type != 'folder' && object.locale && object.locale.length && ~_.findIndex(languages, 'code', object.locale[0])) {
                                                        lang = languages[_.findIndex(languages, 'code', object.locale[0])];
                                                        proceed(msg, lang);
                                                    } else if (object.type == 'form' || object.type == 'folder') {
                                                        proceed(msg, languages);
                                                    }
                                                }
                                            }
                                        ...
                                        helper.queue(urls.all, _query, headers, function (err, data) {
                                            if (err) {
                                                ...
                                                for (var i = 0, _i = data.length; i < _i; i++) {
                                                    ...
                                                    if (data[i].type != 'form' && data[i].type != 'folder' && data[i].locale && data[i].locale.length && ~_.findIndex(languages, 'code', data[i].locale[0])) {
                                                        ...
                                                        proceed(msg, lang);
                                                    } else if (data[i].type == 'form' || data[i].type == 'folder') {
                                                        proceed(msg, languages);
                                                    }
                                                }
                                            }
