...
helper.updateRelease = function (release) {
    try {
        ...
        //         log.error('Release ' + release_uid + '(uid) failed to update status at Contentstack. Error reason::' + JSON.stringify(error));
        //     } else {
