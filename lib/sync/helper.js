...
helper.updateUrl = (function() {
    ...
    return function(entries, contentType, isEntries) {
        try {
            if(entries && contentType && !contentType.singleton && contentType.options && contentType.options.is_page === true && typeof contentType.options.url_pattern === 'string' && contentType.options.url_pattern) {
