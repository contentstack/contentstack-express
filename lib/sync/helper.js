                            ...
                            case "text":
                                ...
                                while ((_matches = regex.exec(_entry[parent[j]])) !== null) {
                                    if (_matches && _matches.length && _matches[6] && _matches[4] && _assets[_matches[6]]) {
                                        var obj = _assets[_matches[6]];
                                        if (obj['url'] && obj['url'] == _matches[0]) __entry = (schema && schema.field_metadata && schema.field_metadata.markdown) ? __entry.replace(_matches[0], encodeURI(_assets[_matches[6]]._internal_url) + "\n") : __entry.replace(_matches[0], _assets[_matches[6]]._internal_url);
                                    }
                                }
                                ...
                                while ((_matches2 = regex2.exec(_entry[parent[j]])) !== null) {
                                    if (_matches2 && _matches2.length && _matches2[4] && _matches2[5] && _assets[_matches2[4]]) {
                                        ...
                                        if (_obj['url'] && _obj['url'] == _matches2[0]) __entry2 = (schema && schema.field_metadata && schema.field_metadata.markdown) ? __entry2.replace(_matches2[0], encodeURI(_assets[_matches2[4]]._internal_url) + "\n") : __entry2.replace(_matches2[0], _assets[_matches2[4]]._internal_url);
                                    }
                                }
