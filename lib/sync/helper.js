...
helper.fetchRelease = function (release, callback) {
    ...
    console.log('Fetching release:', config.get('contentstack.host') + "/" + config.get('contentstack.version') + config.get('contentstack.urls.releases') + release_uid);
    return request({
