...
// }
    try {
        ...
        if (_data.hasOwnProperty('_release_uid')) {
            // 1. Need action
            // 2. Need content type
...
Sync.prototype.entry = function (lang, entry) {
    ...
    try {
        ...
        var ctUID = (entry.object.form) ? entry.object.form.form_uid : (entry.object.content_type && entry.object.content_type.uid) ? entry.object.content_type.uid: entry.object.content_type_uid,
            entryUID = (entry.object.entry.entry_uid) ? entry.object.entry.entry_uid : (entry.object.entry && entry.object.entry.uid) ? entry.object.entry.uid: entry.object.uid,
