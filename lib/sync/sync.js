    ...
    try {
        ...
        async.waterfall([
            ...
            function (data, callback) {
                ...
                helper.executePlugins({type: 'entry', entry: data.entry, content_type: data.content_type, language: lang, action: _action}, callback);
            }
                                    ...
                                    db
                                        ...
                                        .then(function() {
                                            ...
                                            if(!data || (data.options === _content_type.options) || (data.options && _content_type.options && data.options.url_pattern === _content_type.options.url_pattern && data.options.url_prefix === _content_type.options.url_prefix)) {
                                                upsert();
                                            } else if(!_content_type.singleton && _content_type.options && ((!data.options && _content_type.options.url_pattern) || (data.options && data.options.url_pattern !== _content_type.options.url_pattern) || (data.options && data.options.url_prefix !== _content_type.options.url_prefix))) {
                                                async
                                                    .parallel({
