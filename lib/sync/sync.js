    ...
    try {
        ...
        async.waterfall([
            ...
            function (data, callback) {
                if (!remove) {
                    console.log('185 - publish', data.hasOwnProperty('entry'));
                    return self.processAssets(lang, data, callback);
                } else {
                    console.log('188 - unpublish', data.hasOwnProperty('entry'));
