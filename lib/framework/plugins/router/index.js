...
module.exports = function Router() {
	...
	Router.beforePublish = function (data, next) {
		try {
			if (typeof data === "object" && data.entry && typeof data.entry.url === "string" && data.content_type && data.content_type.uid && data.content_type.options && data.content_type.options.is_page) {
				var body = {
					"content_type": {
