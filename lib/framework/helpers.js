...
function find(query) {
    ...
    var __data,
        ...
        data = (cache && process.env.SYNC !== "false") ? InMemory.get(language, contentTypeUid, {}, true) : false,
...
function includeReferences(data, language, references) {
    ...
    var _includeReferences = function (data, parentID) {
        for (var _key in data) {
            if ((_.isUndefined(parentID) || _.isNull(parentID)) && data._metadata && data._metadata.uid) parentID = data._metadata.uid
