                        ...
                        if (query._uid && query._uid.$in) {
                          ...
                          if (typeof parseInt(_key) === 'number') {
                            if (__data.length === 1) {
                              ...
                              // do nothing..?
                              // delete data[_key];
                              // data[_key]._content_type_uid = data[_key]._content_type_id
                              // delete data[_key]._content_type_id
                              // data[_key].error = 'Content might not have been published OR is a duplicate self-reference'
                              data[_key] = {}
                            } else {
                              data[_key] = __data;
                            }
