...
// include references
fileStorage.prototype.includeReferences = function (data, _locale, references, parentID, _inMemory, callback) {
    var self = this,
        calls = [];
                ...
                if (data[_key] && data[_key]["_content_type_id"]) {
                    calls.push(function (_key, data) {
                        return (function (_callback) {
                            ...
                            }, _.cloneDeep(references), parentID, _inMemory);
                        });
                    }(_key, data));
                } else {
            ...
            if (jsonPath && fs.existsSync(jsonPath)) {
                fs.readFile(jsonPath, 'utf-8', function (err, models) {
                    try {
                        ...
                        var _inMemory = _.cloneDeep(models);
                        ...
                        if (data && data.length) {
                            ...
                            if (includeReference) {
                                return self.includeReferences(__data, language, undefined, undefined, _inMemory, _callback);
                            } else {
...
fileStorage.prototype.find = function (query, options, callback) {
    try {
        ...
        if (query && typeof query == "object" && typeof options == "object") {
            ...
            if (_inMemory[query._content_type_uid]) {
                var data = sift(_query, _.cloneDeep(_inMemory[query._content_type_uid]));
                if (parentID) {
                ...
                return self.includeReferences(data, language, references, parentID, _inMemory, callback);
            }
            ...
            if (jsonPath && fs.existsSync(jsonPath)) {
                fs.readFile(jsonPath, 'utf-8', function (err, models) {
                    try {
                        ...
                        _inMemory[query._content_type_uid] = _.cloneDeep(models);
                        ...
                        if (includeReference) {
                            ...
                            return self.includeReferences(__data, language, references, parentID, _inMemory, callback);
                        } else {
                            // When no references are to be attached to the entry object
